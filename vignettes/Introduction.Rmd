...
## Dew point estimation
 ...
 Given that several methods used dew point as an input variable, this package provides methods to estimate the dew point given ambient temperature and relative humidity.
